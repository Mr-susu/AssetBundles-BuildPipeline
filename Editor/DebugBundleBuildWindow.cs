...
namespace UnityEditor.Build
{
    public class DebugBundleBuildWindow : EditorWindow
    {
        ...
        private BuildPipelineCodes ExperimentalBuildPipeline()
        {
            ...
            BuildSettings bundleSettings = BundleBuildPipeline.GenerateBundleBuildSettings(null, m_Settings.buildTarget, m_Settings.buildGroup); // Full pipeline will set typedb during run
